      ...
      >
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12">
          <Popover className="relative">
            ...
            <PopoverPanel
              transition
              className="absolute top-full -left-8 z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-[#17131c] ring-1 shadow-lg ring-gray-900/5 transition data-closed:translate-y-1 data-closed:opacity-0 data-enter:duration-200 data-enter:ease-out data-leave:duration-150 data-leave:ease-in"
            >
              <div className="p-4">
                {products.map((item) => (
                  <div
                  ...
                  >
                    <div className="flex size-11 flex-none items-center justify-center rounded-lg bg-gray">
                      <item.icon
                        aria-hidden="true"
              ...
              <div className="grid grid-cols-2 divide-x divide-gray-900/5 bg-[#17131c]">
                {callsToAction.map((item) => (
                  <a
                    key={item.name}
                    href={item.href}
                    className="flex items-center justify-center gap-x-2.5 p-3 text-sm/6 font-semibold text-gray-900"
                  >
                    <item.icon
                      aria-hidden="true"
                      className="size-5 flex-none text-gray-400"
                  ...
                  <DisclosurePanel className="mt-2 space-y-2">
                    {[...products, ...callsToAction].map((item) => (
                      <DisclosureButton
                        ...
                        as="a"
                        href={item.href}
                        className="block rounded-lg py-2 pr-3 pl-6 text-sm/7 font-semibold text-white hover:bg-gray-500"
                      >
                        {item.name}
                      </DisclosureButton>
                    ))}
